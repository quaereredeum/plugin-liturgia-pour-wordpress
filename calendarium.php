...
function calendarium($date,$ordo) {
...
$reponse="$datelatin, ".$calendarium['tempus'][$aujourdhui].", <a href=\"http://www.societaslaudis.org/index.php?option=com_liturgiahorarum&date=$aujourdhui\">".$calendarium['hebdomada'][$aujourdhui];
